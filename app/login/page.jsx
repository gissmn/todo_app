...
export default function Page() {
  return (
    <form className="flex flex-col items-stretch gap-2">
        ...
        <button className="bg-blue-500 py-2 px-4 rounded-md">Login</button>
        <Link href={'/register'} className="self-end text-blue-700 bg-gray-400 rounded-md py-1 px-2">register?</Link>
    </form>
  )
}
